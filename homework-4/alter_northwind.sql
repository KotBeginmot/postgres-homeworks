...
ALTER TABLE products ADD CONSTRAINT chk_products_discontinued CHECK (discontinued=0 OR discontinued=1);

-- 3. Создать новую таблицу, содержащую все продукты, снятые с продажи (discontinued = 1)
SELECT * INTO sold_products FROM products WHERE products.discontinued = 1;
